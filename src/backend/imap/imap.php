    ...
    public function GetMessage($folderid, $id, $contentparameters) {
        ...
        if ($stat) {
            ...
            if ($deviceType == 'iphone' || $deviceType == 'ipad' || $deviceType == 'ipod') {
                ...
                $is_apple_ios_device = true;
            }
          
            // Prefered format is MIME -OR- message is SMIME -OR- the device supports MIME (iPhone) and doesn't really understand HTML
            if ($bpReturnType == SYNC_BODYPREFERENCE_MIME || ($bpReturnType == SYNC_BODYPREFERENCE_HTML && $is_apple_ios_device) || $is_smime || in_array(SYNC_BODYPREFERENCE_MIME, $bodypreference)) {
